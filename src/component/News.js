                ...
                <div className="container">
                    ...
                    <div className="col-4">
                        ...
                        <div className="card-body">
                            <a href="/tin-chi-tiet"><img src="https://lavenderstudio.com.vn/wp-content/uploads/2021/06/bo-chup-hinh-san-pham-1-800x400.jpg" alt="" className="img-fluid" /></a>
                            <blockquote className="blockquote">                            
                            <p><a href="/tin-chi-tiet">Dịch vụ chụp hình sản phẩm chuyên nghiệp chất lượng nhất tại Việt Nam</a></p>
                    ...
                    <div className="col-4">
                        ...
                        <div className="card">
                            <a href="/tin-chi-tiet"><img className="card-img-top" src="https://lavenderstudio.com.vn/wp-content/uploads/2021/05/dich-vu-chup-hinh-san-pham-2.png" alt="img-fluid" /></a>
                            <div className="card-body">
                            <h4 className="card-title"><a href="/tin-chi-tiet">Crayola Việt Nam</a></h4>
                            <p className="card-text">Tiết lộ địa điểm chụp ảnh profile nữ chất lượng nhất</p>
                            </div>
                        </div>
                        <div className="card">
                            <a href="/tin-chi-tiet"><img className="card-img-top" src="https://lavenderstudio.com.vn/wp-content/uploads/2021/05/chup-hinh-san-pham-dep1-1024x683.jpg" alt="img-fluid" /></a>
                            <div className="card-body">
                            <h4 className="card-title"><a href="/tin-chi-tiet">Category Archives: Quay Chụp Quảng Cáo</a></h4>
